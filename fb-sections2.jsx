  ...
  return (
    <section id="book" className="fb-section" style={{ background: 'var(--navy)', color: '#fff', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="fb-wrap" style={{ position: 'relative', textAlign: 'center', maxWidth: 760 }}>
        ...
        <div className="fb-reveal" style={{ display: 'flex', flexDirection: 'column', gap: 12, alignItems: 'stretch', marginTop: 28, maxWidth: 360, margin: '28px auto 0' }}>
          <a className="fb-btn fb-btn--primary fb-btn--lg fb-btn--onnavy" href="https://rfq.patternlab.ai/login" target="_blank" rel="noopener noreferrer" style={{ justifyContent: 'center', width: '100%', boxSizing: 'border-box' }}><FBIcon name="spark" size={18} /> Try now for free</a>
          <a className="fb-btn fb-btn--secondary fb-btn--lg fb-btn--onnavy" href="/contact" style={{ justifyContent: 'center', width: '100%', boxSizing: 'border-box' }}>Book a demo <FBIcon name="arrowRight" size={16} /></a>
        </div>
