  ...
  return (
    <section id="book" className="fb-section" style={{ background: 'var(--navy)', color: '#fff', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="fb-wrap" style={{ position: 'relative', textAlign: 'center', maxWidth: 760 }}>
        ...
        <div className="fb-reveal fb-cta-btns" style={{ display: 'flex', flexDirection: 'column', gap: 12, alignItems: 'center', marginTop: 28 }}>
          <a className="fb-btn fb-btn--primary fb-btn--lg fb-btn--onnavy fb-cta-btn" href="https://rfq.patternlab.ai/login" target="_blank" rel="noopener noreferrer"><FBIcon name="spark" size={18} /> Try now for free</a>
          <a className="fb-btn fb-btn--secondary fb-btn--lg fb-btn--onnavy fb-cta-btn" href="/contact">Book a demo <FBIcon name="arrowRight" size={16} /></a>
        </div>
